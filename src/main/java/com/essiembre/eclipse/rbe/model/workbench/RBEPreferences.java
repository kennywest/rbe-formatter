...
public enum RBEPreferences {
    ...
    private static String getString(String key) {
        return (String) RBEPreferences.INSTANCE.preferences.get(key);
    }

    private static Boolean getBoolean(String key) {
        Boolean ret = (Boolean) RBEPreferences.INSTANCE.preferences.get(key);
        if (ret == null) {
            return false;
        }
        return ret;
    ...
    private static Integer getInt(String key) {
        return (Integer) RBEPreferences.INSTANCE.preferences.get(key);
    }

    private static Double getDouble(String key) {
        return (Double) RBEPreferences.INSTANCE.preferences.get(key);
    }

    public static void setDefault(String key, Object value) {
        RBEPreferences.INSTANCE.preferences.put(key, value);
    }
    ...
    public static String getKeyGroupSeparator() {
        return getString(KEY_GROUP_SEPARATOR);
    }
    ...
    public static boolean getFieldTabInserts() {
        return getBoolean(FIELD_TAB_INSERTS);
    }
    ...
    public static boolean getAlignEqualSigns() {
        return getBoolean(ALIGN_EQUAL_SIGNS);
    }
    ...
    public static boolean getSpacesAroundEqualSigns() {
        return getBoolean(SPACES_AROUND_EQUAL_SIGNS);
    }
    ...
    public static int getGroupLineBreaks() {
        return getInt(GROUP_LINE_BREAKS);
    }
    ...
    public static boolean getGroupAlignEqualSigns() {
        return getBoolean(GROUP_ALIGN_EQUAL_SIGNS);
    }
    ...
    public static boolean getKeyTreeHierarchical() {
        return getBoolean(KEY_TREE_HIERARCHICAL);
    }
    ...
    public static boolean getKeyTreeExpanded() {
        return getBoolean(KEY_TREE_EXPANDED);
    }
    ...
    public static boolean getShowGenerator() {
        return getBoolean(SHOW_GENERATOR);
    }
    ...
    public static boolean getLoadOnlyFragmentResources() {
        return getBoolean(LOAD_ONLY_FRAGMENT_RESOURCES);
    }
    ...
    public static boolean getSupportFragments() {
        return getBoolean(SUPPORT_FRAGMENTS);
    }
    ...
    public static boolean getWrapAlignEqualSigns() {
        return getBoolean(WRAP_ALIGN_EQUAL_SIGNS);
    }
    ...
    public static int getWrapIndentSpaces() {
        return getInt(WRAP_INDENT_SPACES);
    }
    ...
    public static boolean getConvertEncodedToUnicode() {
        return getBoolean(CONVERT_ENCODED_TO_UNICODE);
    }
    ...
    public static boolean getConvertUnicodeToEncoded() {
        return getBoolean(CONVERT_UNICODE_TO_ENCODED);
    }
    ...
    public static boolean getConvertUnicodeToEncodedUpper() {
        return getBoolean(CONVERT_UNICODE_TO_ENCODED_UPPER);
    }
    ...
    public static boolean getForceNewLineType() {
        return getBoolean(FORCE_NEW_LINE_TYPE);
    }
    ...
    public static boolean getNewLineNice() {
        return getBoolean(NEW_LINE_NICE);
    }
    ...
    public static boolean getReportMissingValues() {
        return getBoolean(REPORT_MISSING_VALUES);
    }
    ...
    public static boolean getReportDuplicateValues() {
        return getBoolean(REPORT_DUPL_VALUES);
    }
    ...
    public static boolean getReportSimilarValues() {
        return getBoolean(REPORT_SIM_VALUES);
    }
    ...
    public static boolean getReportSimilarValuesWordCompare() {
        return getBoolean(REPORT_SIM_VALUES_WORD_COMPARE);
    }
    ...
    public static boolean getReportSimilarValuesLevensthein() {
        return getBoolean(REPORT_SIM_VALUES_LEVENSTHEIN);
    }
    ...
    public static double getReportSimilarValuesPrecision() {
        return getDouble(REPORT_SIM_VALUES_PRECISION);
    }
    ...
    public static boolean getNoTreeInEditor() {
        return getBoolean(NO_TREE_IN_EDITOR);
    }
    ...
    public static boolean getKeepEmptyFields() {
        return getBoolean(KEEP_EMPTY_FIELDS);
    }
